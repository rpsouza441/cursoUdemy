...
//	Page<Produto> search(@Param("nome") String nome, @Param("listaCategorias") List<Categoria> listaCategorias, Pageable pageRequest);

	@Transactional(readOnly = true)
	Page<Produto> findDistinctByNomeContainingAndListaCategoriasIn(@Param("nome") String nome,
			@Param("listaCategorias") List<Categoria> listaCategorias, Pageable pageRequest);
}