...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		est1.getListaCidade().addAll(Arrays.asList(c1));
		est2.getListaCidade().addAll(Arrays.asList(c2, c3));

		estadoRepository.saveAll(Arrays.asList(est1, est2));
		cidadeRepository.saveAll(Arrays.asList(c1, c2, c3));

		Cliente cli1 = new Cliente(null, "Maria Silva", "rpsouzati@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);

		cli1.getListaTelefone().addAll(Arrays.asList("27363323", "93838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);

		cli1.getListaEndereco().addAll(Arrays.asList(e1, e2));
		...
		p2.getListaItem().addAll(Arrays.asList(ip3));
		p3.getListaItem().addAll(Arrays.asList(ip2));
